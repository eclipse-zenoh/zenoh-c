...
/// Constructs an empty `z_owned_slice_t`.
#[no_mangle]
pub extern "C" fn _z_slice_null(this_: &mut MaybeUninit<z_owned_slice_t>) {
    z_slice_empty(this_);
}
...
#[no_mangle]
pub extern "C" fn _z_slice_check(this_: &z_owned_slice_t) -> bool {
    !this_.as_rust_type_ref().is_empty()
}
...
#[no_mangle]
pub extern "C" fn _z_string_check(this_: &z_owned_string_t) -> bool {
    !this_.as_rust_type_ref().is_empty()
}

/// Constructs owned string in a gravestone state.
#[no_mangle]
pub extern "C" fn _z_string_null(this_: &mut MaybeUninit<z_owned_string_t>) {
    this_
        .as_rust_type_mut_uninit()
...
#[no_mangle]
pub extern "C" fn _z_string_array_null(this_: &mut MaybeUninit<z_owned_string_array_t>) {
    this_.as_rust_type_mut_uninit().write(None);
}

/// @return ``true`` if the string array is valid, ``false`` if it is in a gravestone state.
#[no_mangle]
pub extern "C" fn _z_string_array_check(this_: &z_owned_string_array_t) -> bool {
