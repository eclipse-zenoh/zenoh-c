...
#[no_mangle]
pub extern "C" fn _z_shm_provider_null(this_: &mut MaybeUninit<z_owned_shm_provider_t>) {
    this_.as_rust_type_mut_uninit().write(None);
}

/// Returns ``true`` if `this` is valid.
#[no_mangle]
pub extern "C" fn _z_shm_provider_check(this_: &z_owned_shm_provider_t) -> bool {
