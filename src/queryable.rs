...
#[no_mangle]
pub extern "C" fn _z_queryable_null(this_: &mut MaybeUninit<z_owned_queryable_t>) {
...
#[no_mangle]
pub extern "C" fn _z_query_null(this_: &mut MaybeUninit<z_owned_query_t>) {
    this_.as_rust_type_mut_uninit().write(None);
}
/// Returns `false` if `this` is in a gravestone state, `true` otherwise.
#[no_mangle]
pub extern "C" fn _z_query_check(query: &z_owned_query_t) -> bool {
...
#[no_mangle]
pub extern "C" fn _z_queryable_check(this_: &z_owned_queryable_t) -> bool {
