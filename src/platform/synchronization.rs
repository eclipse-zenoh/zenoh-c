...
#[no_mangle]
pub extern "C" fn _z_mutex_check(this_: &z_owned_mutex_t) -> bool {
    this_.as_rust_type_ref().is_some()
}

/// Constructs mutex in a gravestone state.
#[no_mangle]
pub extern "C" fn _z_mutex_null(this_: &mut MaybeUninit<z_owned_mutex_t>) {
...
#[no_mangle]
pub extern "C" fn _z_condvar_null(this_: &mut MaybeUninit<z_owned_condvar_t>) {
    this_.as_rust_type_mut_uninit().write(None);
}
...
#[no_mangle]
pub extern "C" fn _z_condvar_check(this_: &z_owned_condvar_t) -> bool {
    this_.as_rust_type_ref().is_some()
}
...
#[no_mangle]
pub extern "C" fn _z_task_null(this_: &mut MaybeUninit<z_owned_task_t>) {
    this_.as_rust_type_mut_uninit().write(None);
}
...
#[no_mangle]
pub extern "C" fn _z_task_check(this_: &z_owned_task_t) -> bool {
    this_.as_rust_type_ref().is_some()
}
