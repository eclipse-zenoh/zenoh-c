...
#[no_mangle]
pub extern "C" fn z_closure_log_check(this: &zc_owned_closure_log_t) -> bool {
    !this.is_empty()
}

/// Borrows closure.
#[no_mangle]
pub extern "C" fn z_closure_log_loan(closure: &zc_owned_closure_log_t) -> &zc_loaned_closure_log_t {
