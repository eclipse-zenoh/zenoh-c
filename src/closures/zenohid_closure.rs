...
pub unsafe extern "C" fn _z_closure_zid_check(this_: &z_owned_closure_zid_t) -> bool {
    !this_.is_empty()
}
...
#[no_mangle]
#[allow(clippy::missing_safety_doc)]
pub unsafe extern "C" fn _z_closure_zid_null(this_: &mut MaybeUninit<z_owned_closure_zid_t>) {
