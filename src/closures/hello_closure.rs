...
pub unsafe extern "C" fn _z_closure_hello_null(this_: *mut MaybeUninit<z_owned_closure_hello_t>) {
...
#[no_mangle]
pub extern "C" fn _z_closure_hello_check(this_: &z_owned_closure_hello_t) -> bool {
    !this_.is_empty()
}
