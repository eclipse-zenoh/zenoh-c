...
pub struct z_owned_closure_transport_event_t {
    _context: *mut c_void,
    _call: Option<extern "C" fn(event: &mut z_loaned_transport_event_t, context: *mut c_void)>,
...
#[repr(C)]
#[cfg(feature = "unstable")]
pub struct z_loaned_closure_transport_event_t {
    _0: usize,
    _1: usize,
    _2: usize,
}
...
#[cfg(feature = "unstable")]
#[repr(C)]
pub struct z_moved_closure_transport_event_t {
    _this: z_owned_closure_transport_event_t,
}

decl_c_type!(
    owned(z_owned_closure_transport_event_t),
    loaned(z_loaned_closure_transport_event_t),
    moved(z_moved_closure_transport_event_t),
);

impl Default for z_owned_closure_transport_event_t {
    fn default() -> Self {
...
impl z_owned_closure_transport_event_t {
    pub fn is_empty(&self) -> bool {
        self._call.is_none() && self._drop.is_none() && self._context.is_null()
    }
}
unsafe impl Send for z_owned_closure_transport_event_t {}
unsafe impl Sync for z_owned_closure_transport_event_t {}
impl Drop for z_owned_closure_transport_event_t {
    fn drop(&mut self) {
...
#[cfg(feature = "unstable")]
pub unsafe extern "C" fn z_internal_closure_transport_event_null(
    this: &mut MaybeUninit<z_owned_closure_transport_event_t>,
) {
    this.write(z_owned_closure_transport_event_t::default());
}
...
#[no_mangle]
#[cfg(feature = "unstable")]
pub extern "C" fn z_internal_closure_transport_event_check(
    this: &z_owned_closure_transport_event_t,
) -> bool {
    !this.is_empty()
}
...
#[no_mangle]
#[cfg(feature = "unstable")]
pub extern "C" fn z_closure_transport_event_call(
    closure: &z_loaned_closure_transport_event_t,
...
impl<F: Fn(&mut z_loaned_transport_event_t)> From<F> for z_owned_closure_transport_event_t {
    fn from(f: F) -> Self {
        let this = Box::into_raw(Box::new(f)) as _;
        extern "C" fn call<F: Fn(&mut z_loaned_transport_event_t)>(
            event: &mut z_loaned_transport_event_t,
            this: *mut c_void,
        ) {
...
#[no_mangle]
#[cfg(feature = "unstable")]
pub extern "C" fn z_closure_transport_event_loan(
    closure: &z_owned_closure_transport_event_t,
...
#[no_mangle]
#[cfg(feature = "unstable")]
pub extern "C" fn z_closure_transport_event(
    this: &mut MaybeUninit<z_owned_closure_transport_event_t>,
    call: Option<extern "C" fn(event: &mut z_loaned_transport_event_t, context: *mut c_void)>,
    drop: Option<extern "C" fn(context: *mut c_void)>,
    context: *mut c_void,
) {
    this.write(z_owned_closure_transport_event_t {
        _context: context,
        _call: call,
        _drop: drop,
    });
