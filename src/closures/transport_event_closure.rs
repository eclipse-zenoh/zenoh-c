...
pub struct z_owned_closure_transport_event_t {
    _context: *mut c_void,
    _call: Option<extern "C" fn(event: &z_loaned_transport_event_t, context: *mut c_void)>,
...
impl<F: Fn(&z_loaned_transport_event_t)> From<F> for z_owned_closure_transport_event_t {
    fn from(f: F) -> Self {
        let this = Box::into_raw(Box::new(f)) as _;
        extern "C" fn call<F: Fn(&z_loaned_transport_event_t)>(
            event: &z_loaned_transport_event_t,
            this: *mut c_void,
        ) {
...
pub extern "C" fn z_closure_transport_event(
    this: &mut MaybeUninit<z_owned_closure_transport_event_t>,
    call: Option<extern "C" fn(event: &z_loaned_transport_event_t, context: *mut c_void)>,
