...
typedef enum z_query_target_t {
   ...
   */
  Z_QUERY_TARGET_T_BEST_MATCHING = 0,
  /**
   * All matching queryables.
   */
  Z_QUERY_TARGET_T_ALL = 1,
  /**
   * All complete queryables.
   */
  Z_QUERY_TARGET_T_ALL_COMPLETE = 2,
} z_query_target_t;
...
typedef enum z_reliability_t {
   ...
   */
  Z_RELIABILITY_T_BEST_EFFORT = 0,
  /**
   * Defines reliability as ``RELIABLE``
   */
  Z_RELIABILITY_T_RELIABLE = 1,
} z_reliability_t;
...
typedef enum z_what_t {
  ...
  Z_WHAT_T_PEER = 2,
  Z_WHAT_T_CLIENT = 4,
  Z_WHAT_T_ROUTER_PEER = 3,
  Z_WHAT_T_ROUTER_CLIENT = 5,
  Z_WHAT_T_PEER_CLIENT = 6,
  Z_WHAT_T_ROUTER_PEER_CLIENT = 7,
} z_what_t;
...
typedef enum ze_advanced_publisher_heartbeat_mode_t {
   ...
   */
  ZE_ADVANCED_PUBLISHER_HEARTBEAT_MODE_T_NONE = 0,
  /**
   ...
   */
  ZE_ADVANCED_PUBLISHER_HEARTBEAT_MODE_T_PERIODIC = 1,
  /**
   ...
   */
  ZE_ADVANCED_PUBLISHER_HEARTBEAT_MODE_T_SPORADIC = 2,
