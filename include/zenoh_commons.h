...
ZENOHC_API uint64_t zp_time_elapsed_ms(const struct zp_time_t *time);
ZENOHC_API uint64_t zp_time_elapsed_s(const struct zp_time_t *time);
ZENOHC_API uint64_t zp_time_elapsed_us(const struct zp_time_t *time);
