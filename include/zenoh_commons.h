...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
z_result_t ze_deserializer_deserialize_sequence_begin(ze_deserializer_t *this_,
                                                      size_t *len);
#endif
/**
...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
z_result_t ze_serializer_from_bytes(ze_owned_serializer_t *this_,
                                    struct z_moved_bytes_t *bytes);
#endif
/**
 * Borrows serializer.
...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
void ze_serializer_serialize_buf(ze_loaned_serializer_t *this_,
                                 const uint8_t *data,
                                 size_t len);
#endif
/**
...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
void ze_serializer_serialize_sequence_begin(ze_loaned_serializer_t *this_,
                                            size_t len);
#endif
/**
...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
void ze_serializer_serialize_slice(ze_loaned_serializer_t *this_,
                                   const struct z_loaned_slice_t *slice);
#endif
/**
 * Serializes a null-terminated string.
...
#if defined(Z_FEATURE_UNSTABLE_API)
ZENOHC_API
void ze_serializer_serialize_string(ze_loaned_serializer_t *this_,
                                    const struct z_loaned_string_t *str);
#endif
/**
 * Serializes an unsigned integer.
