...
#define z_drop(x) _Generic((x), z_owned_session_t                                        \
                           ...
                           : z_owned_closure_sample_drop, z_owned_closure_query_t        \
                           : z_owned_closure_query_drop, z_owned_closure_reply_t         \
                           : z_owned_closure_reply_drop, z_owned_reply_channel_closure_t \
                           : z_owned_reply_channel_closure_drop)(&x)
...
#define z_call(x, ...) _Generic((x), z_owned_closure_sample_t                                 \
                                : z_owned_closure_sample_call, z_owned_closure_query_t        \
                                : z_owned_closure_query_call, z_owned_closure_reply_t         \
                                : z_owned_closure_reply_call, z_owned_reply_channel_closure_t \
                                : z_owned_reply_channel_closure_call)(&x, __VA_ARGS__)
