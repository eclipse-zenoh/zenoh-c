...
#define z_loan_mut(this_) \
    _Generic((this_), \
        ...
        z_owned_memory_layout_t : z_memory_layout_loan_mut, \
        ...
        z_owned_shm_client_storage_t : z_shm_client_storage_loan_mut, \
        z_owned_shm_t : z_shm_loan_mut, \
        z_owned_shm_mut_t : z_shm_mut_loan_mut, \
        z_owned_shm_provider_t : z_shm_provider_loan_mut, \
...
inline z_loaned_memory_layout_t* z_loan_mut(z_owned_memory_layout_t& this_) { return z_memory_layout_loan_mut(&this_); };
...
inline z_loaned_shm_client_storage_t* z_loan_mut(z_owned_shm_client_storage_t& this_) { return z_shm_client_storage_loan_mut(&this_); };
...
inline z_loaned_shm_provider_t* z_loan_mut(z_owned_shm_provider_t& this_) { return z_shm_provider_loan_mut(&this_); };
