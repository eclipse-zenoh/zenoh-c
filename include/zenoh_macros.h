...
inline void z_drop(z_owned_config_t* config) { return z_config_drop(config); };
inline void z_drop(z_owned_encoding_t* encoding) { return z_encoding_drop(encoding); };
inline void z_drop(z_owned_hello_t* this_) { return z_hello_drop(this_); };
inline void z_drop(z_owned_keyexpr_t* keyexpr) { return z_keyexpr_drop(keyexpr); };
...
inline void z_drop(z_owned_sample_t* sample) { return z_sample_drop(sample); };
inline void z_drop(z_owned_scouting_config_t* config) { return z_scouting_config_drop(config); };
