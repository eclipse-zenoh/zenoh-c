...
#define z_loan_mut(this_) \
    _Generic((this_), \
        ...
        z_owned_closure_zid_t : z_closure_zid_loan_mut, \
        z_owned_condvar_t : z_condvar_loan_mut, \
        z_owned_config_t : z_config_loan_mut, \
        z_owned_encoding_t : z_encoding_loan_mut, \
        z_owned_fifo_handler_query_t : z_fifo_handler_query_loan_mut, \
        z_owned_fifo_handler_reply_t : z_fifo_handler_reply_loan_mut, \
        z_owned_fifo_handler_sample_t : z_fifo_handler_sample_loan_mut, \
        ...
        z_owned_ring_handler_query_t : z_ring_handler_query_loan_mut, \
        z_owned_ring_handler_reply_t : z_ring_handler_reply_loan_mut, \
        z_owned_ring_handler_sample_t : z_ring_handler_sample_loan_mut, \
...
#define z_take(this_, x) \
    _Generic((x), \
        z_moved_bytes_t* : z_bytes_take, \
        z_moved_bytes_writer_t* : z_bytes_writer_take, \
        z_moved_closure_hello_t* : z_closure_hello_take, \
        z_moved_closure_query_t* : z_closure_query_take, \
        z_moved_closure_reply_t* : z_closure_reply_take, \
        z_moved_closure_sample_t* : z_closure_sample_take, \
        z_moved_closure_zid_t* : z_closure_zid_take, \
        z_moved_condvar_t* : z_condvar_take, \
        z_moved_config_t* : z_config_take, \
        z_moved_encoding_t* : z_encoding_take, \
        z_moved_fifo_handler_query_t* : z_fifo_handler_query_take, \
        z_moved_fifo_handler_reply_t* : z_fifo_handler_reply_take, \
        z_moved_fifo_handler_sample_t* : z_fifo_handler_sample_take, \
        z_moved_hello_t* : z_hello_take, \
        z_moved_keyexpr_t* : z_keyexpr_take, \
        z_moved_mutex_t* : z_mutex_take, \
        z_moved_publisher_t* : z_publisher_take, \
        z_moved_query_t* : z_query_take, \
        z_moved_queryable_t* : z_queryable_take, \
        z_moved_reply_t* : z_reply_take, \
        z_moved_reply_err_t* : z_reply_err_take, \
        z_moved_ring_handler_query_t* : z_ring_handler_query_take, \
        z_moved_ring_handler_reply_t* : z_ring_handler_reply_take, \
        z_moved_ring_handler_sample_t* : z_ring_handler_sample_take, \
        z_moved_sample_t* : z_sample_take, \
        z_moved_session_t* : z_session_take, \
        z_moved_slice_t* : z_slice_take, \
        z_moved_string_array_t* : z_string_array_take, \
        z_moved_string_t* : z_string_take, \
        z_moved_subscriber_t* : z_subscriber_take, \
        z_moved_task_t* : z_task_take, \
        ...
        z_loaned_closure_sample_t* : z_closure_sample_take_loaned, \
        z_loaned_closure_zid_t* : z_closure_zid_take_loaned, \
        z_loaned_config_t* : z_config_take_loaned, \
        z_loaned_encoding_t* : z_encoding_take_loaned, \
        z_loaned_fifo_handler_query_t* : z_fifo_handler_query_take_loaned, \
        z_loaned_fifo_handler_reply_t* : z_fifo_handler_reply_take_loaned, \
        z_loaned_fifo_handler_sample_t* : z_fifo_handler_sample_take_loaned, \
        z_loaned_hello_t* : z_hello_take_loaned, \
        z_loaned_keyexpr_t* : z_keyexpr_take_loaned, \
        z_loaned_mutex_t* : z_mutex_take_loaned, \
        z_loaned_publisher_t* : z_publisher_take_loaned, \
        z_loaned_query_t* : z_query_take_loaned, \
        z_loaned_queryable_t* : z_queryable_take_loaned, \
        z_loaned_reply_err_t* : z_reply_err_take_loaned, \
        z_loaned_reply_t* : z_reply_take_loaned, \
        z_loaned_ring_handler_query_t* : z_ring_handler_query_take_loaned, \
        z_loaned_ring_handler_reply_t* : z_ring_handler_reply_take_loaned, \
        z_loaned_ring_handler_sample_t* : z_ring_handler_sample_take_loaned, \
        z_loaned_sample_t* : z_sample_take_loaned, \
        z_loaned_session_t* : z_session_take_loaned, \
...
inline z_loaned_closure_zid_t* z_loan_mut(z_owned_closure_zid_t& closure) { return z_closure_zid_loan_mut(&closure); };
...
inline z_loaned_fifo_handler_query_t* z_loan_mut(z_owned_fifo_handler_query_t& this_) { return z_fifo_handler_query_loan_mut(&this_); };
inline z_loaned_fifo_handler_reply_t* z_loan_mut(z_owned_fifo_handler_reply_t& this_) { return z_fifo_handler_reply_loan_mut(&this_); };
inline z_loaned_fifo_handler_sample_t* z_loan_mut(z_owned_fifo_handler_sample_t& this_) { return z_fifo_handler_sample_loan_mut(&this_); };
inline z_loaned_hello_t* z_loan_mut(z_owned_hello_t& this_) { return z_hello_loan_mut(&this_); };
inline z_loaned_keyexpr_t* z_loan_mut(z_owned_keyexpr_t& this_) { return z_keyexpr_loan_mut(&this_); };
...
inline z_loaned_queryable_t* z_loan_mut(z_owned_queryable_t& this_) { return z_queryable_loan_mut(&this_); };
...
inline z_loaned_ring_handler_query_t* z_loan_mut(z_owned_ring_handler_query_t& this_) { return z_ring_handler_query_loan_mut(&this_); };
inline z_loaned_ring_handler_reply_t* z_loan_mut(z_owned_ring_handler_reply_t& this_) { return z_ring_handler_reply_loan_mut(&this_); };
inline z_loaned_ring_handler_sample_t* z_loan_mut(z_owned_ring_handler_sample_t& this_) { return z_ring_handler_sample_loan_mut(&this_); };
...
inline z_loaned_slice_t* z_loan_mut(z_owned_slice_t& this_) { return z_slice_loan_mut(&this_); };
inline z_loaned_string_array_t* z_loan_mut(z_owned_string_array_t& this_) { return z_string_array_loan_mut(&this_); };
inline z_loaned_string_t* z_loan_mut(z_owned_string_t& this_) { return z_string_loan_mut(&this_); };
inline z_loaned_subscriber_t* z_loan_mut(z_owned_subscriber_t& this_) { return z_subscriber_loan_mut(&this_); };
...
inline void z_take(z_owned_closure_query_t* dst, z_loaned_closure_query_t* src) {
    z_closure_query_take_loaned(dst, src);
};
inline void z_take(z_owned_closure_reply_t* dst, z_loaned_closure_reply_t* src) {
    z_closure_reply_take_loaned(dst, src);
};
inline void z_take(z_owned_closure_sample_t* dst, z_loaned_closure_sample_t* src) {
    z_closure_sample_take_loaned(dst, src);
};
inline void z_take(z_owned_closure_zid_t* dst, z_loaned_closure_zid_t* src) {
    z_closure_zid_take_loaned(dst, src);
};
inline void z_take(z_owned_config_t* dst, z_loaned_config_t* src) {
    z_config_take_loaned(dst, src);
};
inline void z_take(z_owned_encoding_t* dst, z_loaned_encoding_t* src) {
    z_encoding_take_loaned(dst, src);
};
inline void z_take(z_owned_fifo_handler_query_t* dst, z_loaned_fifo_handler_query_t* src) {
    z_fifo_handler_query_take_loaned(dst, src);
};
inline void z_take(z_owned_fifo_handler_reply_t* dst, z_loaned_fifo_handler_reply_t* src) {
    z_fifo_handler_reply_take_loaned(dst, src);
};
inline void z_take(z_owned_fifo_handler_sample_t* dst, z_loaned_fifo_handler_sample_t* src) {
    z_fifo_handler_sample_take_loaned(dst, src);
};
inline void z_take(z_owned_hello_t* dst, z_loaned_hello_t* src) {
    z_hello_take_loaned(dst, src);
};
inline void z_take(z_owned_keyexpr_t* dst, z_loaned_keyexpr_t* src) {
    z_keyexpr_take_loaned(dst, src);
};
inline void z_take(z_owned_mutex_t* dst, z_loaned_mutex_t* src) {
    z_mutex_take_loaned(dst, src);
};
inline void z_take(z_owned_publisher_t* dst, z_loaned_publisher_t* src) {
    z_publisher_take_loaned(dst, src);
};
inline void z_take(z_owned_query_t* dst, z_loaned_query_t* src) {
    z_query_take_loaned(dst, src);
};
inline void z_take(z_owned_queryable_t* dst, z_loaned_queryable_t* src) {
    z_queryable_take_loaned(dst, src);
};
inline void z_take(z_owned_reply_err_t* dst, z_loaned_reply_err_t* src) {
    z_reply_err_take_loaned(dst, src);
};
inline void z_take(z_owned_reply_t* dst, z_loaned_reply_t* src) {
    z_reply_take_loaned(dst, src);
};
inline void z_take(z_owned_ring_handler_query_t* dst, z_loaned_ring_handler_query_t* src) {
    z_ring_handler_query_take_loaned(dst, src);
};
inline void z_take(z_owned_ring_handler_reply_t* dst, z_loaned_ring_handler_reply_t* src) {
    z_ring_handler_reply_take_loaned(dst, src);
};
inline void z_take(z_owned_ring_handler_sample_t* dst, z_loaned_ring_handler_sample_t* src) {
    z_ring_handler_sample_take_loaned(dst, src);
};
inline void z_take(z_owned_sample_t* dst, z_loaned_sample_t* src) {
    z_sample_take_loaned(dst, src);
};
inline void z_take(z_owned_session_t* dst, z_loaned_session_t* src) {
    z_session_take_loaned(dst, src);
};
inline void z_take(z_owned_slice_t* dst, z_loaned_slice_t* src) {
    z_slice_take_loaned(dst, src);
};
inline void z_take(z_owned_string_array_t* dst, z_loaned_string_array_t* src) {
    z_string_array_take_loaned(dst, src);
};
inline void z_take(z_owned_string_t* dst, z_loaned_string_t* src) {
    z_string_take_loaned(dst, src);
};
