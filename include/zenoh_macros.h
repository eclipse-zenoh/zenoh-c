...
extern "C" using z_closure_zid_callback_t = void(const z_id_t*, void*);
inline void z_closure(
...
extern "C" using zc_closure_matching_status_callback_t = void(const zc_matching_status_t*, void*);
inline void z_closure(
    zc_owned_closure_matching_status_t* closure,
    zc_closure_matching_status_callback_t* call,
    z_closure_drop_callback_t* drop,
    void *context) {
    closure->context = context;
    closure->drop = drop;
