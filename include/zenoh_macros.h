...
#define z_null(this_) \
    _Generic((this_), \
        ...
        zc_owned_matching_listener_t* : zc_matching_listener_null, \
...
static inline void z_alloc_layout_take(z_owned_alloc_layout_t* this_, z_moved_alloc_layout_t* x) { *this_ = x->_this; z_alloc_layout_null(&x->_this); }
static inline void z_bytes_take(z_owned_bytes_t* this_, z_moved_bytes_t* x) { *this_ = x->_this; z_bytes_null(&x->_this); }
static inline void z_chunk_alloc_result_take(z_owned_chunk_alloc_result_t* this_, z_moved_chunk_alloc_result_t* x) { *this_ = x->_this; z_chunk_alloc_result_null(&x->_this); }
...
static inline void z_closure_zid_take(z_owned_closure_zid_t* closure_, z_moved_closure_zid_t* x) { *closure_ = x->_this; z_closure_zid_null(&x->_this); }
...
static inline void z_memory_layout_take(z_owned_memory_layout_t* this_, z_moved_memory_layout_t* x) { *this_ = x->_this; z_memory_layout_null(&x->_this); }
...
static inline void z_shm_client_take(z_owned_shm_client_t* this_, z_moved_shm_client_t* x) { *this_ = x->_this; z_shm_client_null(&x->_this); }
static inline void z_shm_client_storage_take(z_owned_shm_client_storage_t* this_, z_moved_shm_client_storage_t* x) { *this_ = x->_this; z_shm_client_storage_null(&x->_this); }
static inline void z_shm_take(z_owned_shm_t* this_, z_moved_shm_t* x) { *this_ = x->_this; z_shm_null(&x->_this); }
static inline void z_shm_mut_take(z_owned_shm_mut_t* this_, z_moved_shm_mut_t* x) { *this_ = x->_this; z_shm_mut_null(&x->_this); }
static inline void z_shm_provider_take(z_owned_shm_provider_t* this_, z_moved_shm_provider_t* x) { *this_ = x->_this; z_shm_provider_null(&x->_this); }
static inline void z_slice_take(z_owned_slice_t* this_, z_moved_slice_t* x) { *this_ = x->_this; z_slice_null(&x->_this); }
static inline void z_source_info_take(z_owned_source_info_t* this_, z_moved_source_info_t* x) { *this_ = x->_this; z_source_info_null(&x->_this); }
...
static inline void zc_closure_matching_status_take(zc_owned_closure_matching_status_t* closure_, zc_moved_closure_matching_status_t* x) { *closure_ = x->_this; zc_closure_matching_status_null(&x->_this); }
static inline void zc_liveliness_token_take(zc_owned_liveliness_token_t* this_, zc_moved_liveliness_token_t* x) { *this_ = x->_this; zc_liveliness_token_null(&x->_this); }
static inline void zc_publisher_matching_listener_take(zc_owned_matching_listener_t* this_, zc_moved_matching_listener_t* x) { *this_ = x->_this; zc_matching_listener_null(&x->_this); }
static inline void zc_shm_client_list_take(zc_owned_shm_client_list_t* this_, zc_moved_shm_client_list_t* x) { *this_ = x->_this; zc_shm_client_list_null(&x->_this); }
static inline void ze_publication_cache_take(ze_owned_publication_cache_t* this_, ze_moved_publication_cache_t* x) { *this_ = x->_this; ze_publication_cache_null(&x->_this); }
static inline void ze_querying_subscriber_take(ze_owned_querying_subscriber_t* this_, ze_moved_querying_subscriber_t* x) { *this_ = x->_this; ze_querying_subscriber_null(&x->_this); }
...
#define z_check(this_) \
    _Generic((this_), \
        ...
        zc_owned_matching_listener_t : zc_matching_listener_check, \
...
static inline z_moved_alloc_layout_t* z_alloc_layout_move(z_owned_alloc_layout_t* x) { return reinterpret_cast<z_moved_alloc_layout_t*>(x); }
...
static inline z_moved_source_info_t* z_source_info_move(z_owned_source_info_t* x) { return reinterpret_cast<z_moved_source_info_t*>(x); }
...
static inline zc_moved_liveliness_token_t* zc_liveliness_token_move(zc_owned_liveliness_token_t* x) { return reinterpret_cast<zc_moved_liveliness_token_t*>(x); }
...
inline z_result_t z_drop(zc_moved_matching_listener_t* this_) { return zc_publisher_matching_listener_drop(this_); };
...
inline void z_null(z_owned_alloc_layout_t* this_) { z_alloc_layout_null(this_); };
inline void z_null(z_owned_bytes_t* this_) { z_bytes_null(this_); };
inline void z_null(z_owned_chunk_alloc_result_t* this_) { z_chunk_alloc_result_null(this_); };
...
inline void z_null(z_owned_closure_zid_t* this_) { z_closure_zid_null(this_); };
...
inline void z_null(z_owned_memory_layout_t* this_) { z_memory_layout_null(this_); };
...
inline void z_null(z_owned_shm_client_t* this_) { z_shm_client_null(this_); };
inline void z_null(z_owned_shm_client_storage_t* this_) { z_shm_client_storage_null(this_); };
inline void z_null(z_owned_shm_mut_t* this_) { z_shm_mut_null(this_); };
inline void z_null(z_owned_shm_t* this_) { z_shm_null(this_); };
inline void z_null(z_owned_shm_provider_t* this_) { z_shm_provider_null(this_); };
inline void z_null(z_owned_slice_t* this_) { z_slice_null(this_); };
inline void z_null(z_owned_source_info_t* this_) { z_source_info_null(this_); };
...
inline void z_null(zc_owned_closure_log_t* this_) { zc_closure_log_null(this_); };
inline void z_null(zc_owned_closure_matching_status_t* this_) { zc_closure_matching_status_null(this_); };
inline void z_null(zc_owned_liveliness_token_t* this_) { zc_liveliness_token_null(this_); };
inline void z_null(zc_owned_matching_listener_t* this_) { zc_matching_listener_null(this_); };
inline void z_null(zc_owned_shm_client_list_t* this_) { zc_shm_client_list_null(this_); };
inline void z_null(ze_owned_publication_cache_t* this_) { ze_publication_cache_null(this_); };
inline void z_null(ze_owned_querying_subscriber_t* this_) { ze_querying_subscriber_null(this_); };
...
inline bool z_check(const zc_owned_matching_listener_t& this_) { return zc_matching_listener_check(&this_); };
