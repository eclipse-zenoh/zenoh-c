...
static inline void z_alloc_layout_take(z_owned_alloc_layout_t* this_, z_moved_alloc_layout_t x) { *this_ = *x._ptr; z_alloc_layout_null(x._ptr); }
static inline void z_bytes_take(z_owned_bytes_t* this_, z_moved_bytes_t x) { *this_ = *x._ptr; z_bytes_null(x._ptr); }
static inline void z_chunk_alloc_result_take(z_owned_chunk_alloc_result_t* this_, z_moved_chunk_alloc_result_t x) { *this_ = *x._ptr; z_chunk_alloc_result_null(x._ptr); }
static inline void z_closure_hello_take(z_owned_closure_hello_t* this_, z_moved_closure_hello_t x) { *this_ = *x._ptr; z_closure_hello_null(x._ptr); }
static inline void z_closure_query_take(z_owned_closure_query_t* closure_, z_moved_closure_query_t x) { *closure_ = *x._ptr; z_closure_query_null(x._ptr); }
static inline void z_closure_reply_take(z_owned_closure_reply_t* closure_, z_moved_closure_reply_t x) { *closure_ = *x._ptr; z_closure_reply_null(x._ptr); }
static inline void z_closure_sample_take(z_owned_closure_sample_t* closure_, z_moved_closure_sample_t x) { *closure_ = *x._ptr; z_closure_sample_null(x._ptr); }
static inline void z_closure_zid_take(z_owned_closure_zid_t* closure_, z_moved_closure_zid_t x) { *closure_ = *x._ptr; z_closure_zid_null(x._ptr); }
...
static inline void z_memory_layout_take(z_owned_memory_layout_t* this_, z_moved_memory_layout_t x) { *this_ = *x._ptr; z_memory_layout_null(x._ptr); }
static inline void z_mutex_take(z_owned_mutex_t* this_, z_moved_mutex_t x) { *this_ = *x._ptr; z_mutex_null(x._ptr); }
static inline void z_publisher_take(z_owned_publisher_t* _this, z_moved_publisher_t x) { *_this = *x._ptr; z_publisher_null(x._ptr); }
...
static inline void z_shm_client_take(z_owned_shm_client_t* this_, z_moved_shm_client_t x) { *this_ = *x._ptr; z_shm_client_null(x._ptr); }
static inline void z_shm_client_storage_take(z_owned_shm_client_storage_t* this_, z_moved_shm_client_storage_t x) { *this_ = *x._ptr; z_shm_client_storage_null(x._ptr); }
static inline void z_shm_take(z_owned_shm_t* this_, z_moved_shm_t x) { *this_ = *x._ptr; z_shm_null(x._ptr); }
static inline void z_shm_mut_take(z_owned_shm_mut_t* this_, z_moved_shm_mut_t x) { *this_ = *x._ptr; z_shm_mut_null(x._ptr); }
static inline void z_shm_provider_take(z_owned_shm_provider_t* this_, z_moved_shm_provider_t x) { *this_ = *x._ptr; z_shm_provider_null(x._ptr); }
static inline void z_slice_take(z_owned_slice_t* this_, z_moved_slice_t x) { *this_ = *x._ptr; z_slice_null(x._ptr); }
static inline void z_source_info_take(z_owned_source_info_t* this_, z_moved_source_info_t x) { *this_ = *x._ptr; z_source_info_null(x._ptr); }
...
static inline void z_task_take(z_owned_task_t* this_, z_moved_task_t x) { *this_ = *x._ptr; z_task_null(x._ptr); }
static inline void zc_closure_log_take(zc_owned_closure_log_t* closure_, zc_moved_closure_log_t x) { *closure_ = *x._ptr; zc_closure_log_null(x._ptr); }
static inline void zc_closure_matching_status_take(zc_owned_closure_matching_status_t* closure_, zc_moved_closure_matching_status_t x) { *closure_ = *x._ptr; zc_closure_matching_status_null(x._ptr); }
static inline void zc_liveliness_token_take(zc_owned_liveliness_token_t* this_, zc_moved_liveliness_token_t x) { *this_ = *x._ptr; zc_liveliness_token_null(x._ptr); }
static inline void zc_publisher_matching_listener_take(zc_owned_matching_listener_t* this_, zc_moved_matching_listener_t x) { *this_ = *x._ptr; zc_matching_listener_null(x._ptr); }
static inline void zc_shm_client_list_take(zc_owned_shm_client_list_t* this_, zc_moved_shm_client_list_t x) { *this_ = *x._ptr; zc_shm_client_list_null(x._ptr); }
static inline void ze_publication_cache_take(ze_owned_publication_cache_t* _this, ze_moved_publication_cache_t x) { *_this = *x._ptr; ze_publication_cache_null(x._ptr); }
static inline void ze_querying_subscriber_take(ze_owned_querying_subscriber_t* _this, ze_moved_querying_subscriber_t x) { *_this = *x._ptr; ze_querying_subscriber_null(x._ptr); }
...
inline void z_drop(z_moved_publisher_t _this) { z_publisher_drop(_this); };
...
inline void z_drop(ze_moved_publication_cache_t _this) { ze_publication_cache_drop(_this); };
inline void z_drop(ze_moved_querying_subscriber_t _this) { ze_querying_subscriber_drop(_this); };
...
inline z_moved_publisher_t z_move(z_owned_publisher_t& _this) { return z_publisher_move(&_this); };
...
inline ze_moved_publication_cache_t z_move(ze_owned_publication_cache_t& _this) { return ze_publication_cache_move(&_this); };
inline ze_moved_querying_subscriber_t z_move(ze_owned_querying_subscriber_t& _this) { return ze_querying_subscriber_move(&_this); };
...
inline void z_take(z_owned_publisher_t* _this, z_moved_publisher_t x) {
    z_publisher_take(_this, x);
};
...
inline void z_take(ze_owned_publication_cache_t* _this, ze_moved_publication_cache_t x) {
    ze_publication_cache_take(_this, x);
};
inline void z_take(ze_owned_querying_subscriber_t* _this, ze_moved_querying_subscriber_t x) {
    ze_querying_subscriber_take(_this, x);
};
