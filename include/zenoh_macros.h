...
static inline void z_closure_zid_take(z_owned_closure_zid_t* closure, z_moved_closure_zid_t x) { *closure = *x._ptr; z_closure_zid_null(x._ptr); }
...
static inline void zc_closure_log_take(zc_owned_closure_log_t* closure, zc_moved_closure_log_t x) { *closure = *x._ptr; zc_closure_log_null(x._ptr); }
static inline void zc_closure_matching_status_take(zc_owned_closure_matching_status_t* closure, zc_moved_closure_matching_status_t x) { *closure = *x._ptr; zc_closure_matching_status_null(x._ptr); }
...
static inline void ze_publication_cache_take(ze_owned_publication_cache_t* this_, ze_moved_publication_cache_t x) { *this_ = *x._ptr; ze_publication_cache_null(x._ptr); }
static inline void ze_querying_subscriber_take(ze_owned_querying_subscriber_t* this_, ze_moved_querying_subscriber_t x) { *this_ = *x._ptr; ze_querying_subscriber_null(x._ptr); }
...
inline void z_drop(z_moved_closure_zid_t closure) { z_closure_zid_drop(closure); };
...
inline void z_drop(zc_moved_closure_log_t closure) { zc_closure_log_drop(closure); };
inline void z_drop(zc_moved_closure_matching_status_t closure) { zc_closure_matching_status_drop(closure); };
...
inline zc_moved_closure_log_t z_move(zc_owned_closure_log_t& closure) { return zc_closure_log_move(&closure); };
inline zc_moved_closure_matching_status_t z_move(zc_owned_closure_matching_status_t& closure) { return zc_closure_matching_status_move(&closure); };
...
inline void z_take(z_owned_closure_zid_t* closure, z_moved_closure_zid_t x) {
    z_closure_zid_take(closure, x);
};
...
inline void z_take(zc_owned_closure_log_t* closure, zc_moved_closure_log_t x) {
    zc_closure_log_take(closure, x);
};
inline void z_take(zc_owned_closure_matching_status_t* closure, zc_moved_closure_matching_status_t x) {
    zc_closure_matching_status_take(closure, x);
};
