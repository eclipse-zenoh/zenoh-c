...
#define _z_null(this_) \
    _Generic((this_), \
        z_owned_bytes_t* : _z_bytes_null, \
        z_owned_closure_hello_t* : _z_closure_hello_null, \
        z_owned_closure_query_t* : _z_closure_query_null, \
        z_owned_closure_reply_t* : _z_closure_reply_null, \
        z_owned_closure_sample_t* : _z_closure_sample_null, \
        z_owned_condvar_t* : _z_condvar_null, \
        z_owned_config_t* : _z_config_null, \
        z_owned_encoding_t* : _z_encoding_null, \
        z_owned_fifo_handler_query_t* : _z_fifo_handler_query_null, \
        z_owned_fifo_handler_reply_t* : _z_fifo_handler_reply_null, \
        z_owned_fifo_handler_sample_t* : _z_fifo_handler_sample_null, \
        z_owned_hello_t* : _z_hello_null, \
        z_owned_keyexpr_t* : _z_keyexpr_null, \
        z_owned_mutex_t* : _z_mutex_null, \
        z_owned_publisher_t* : _z_publisher_null, \
        z_owned_query_t* : _z_query_null, \
        z_owned_queryable_t* : _z_queryable_null, \
        z_owned_reply_err_t* : _z_reply_err_null, \
        z_owned_reply_t* : _z_reply_null, \
        z_owned_ring_handler_query_t* : _z_ring_handler_query_null, \
        z_owned_ring_handler_reply_t* : _z_ring_handler_reply_null, \
        z_owned_ring_handler_sample_t* : _z_ring_handler_sample_null, \
        z_owned_sample_t* : _z_sample_null, \
        z_owned_session_t* : _z_session_null, \
        z_owned_slice_t* : _z_slice_null, \
        z_owned_string_array_t* : _z_string_array_null, \
        z_owned_string_t* : _z_string_null, \
        z_owned_subscriber_t* : _z_subscriber_null, \
        z_owned_task_t* : _z_task_null, \
        zc_owned_closure_log_t* : _zc_closure_log_null \
    )(this_)
...
static inline void z_closure_query_take(z_owned_closure_query_t* closure_, z_moved_closure_query_t* x) { *closure_ = x->_this; z_closure_query_null(&x->_this); }
static inline void z_closure_reply_take(z_owned_closure_reply_t* closure_, z_moved_closure_reply_t* x) { *closure_ = x->_this; z_closure_reply_null(&x->_this); }
static inline void z_closure_sample_take(z_owned_closure_sample_t* closure_, z_moved_closure_sample_t* x) { *closure_ = x->_this; z_closure_sample_null(&x->_this); }
static inline void z_condvar_take(z_owned_condvar_t* this_, z_moved_condvar_t* x) { *this_ = x->_this; z_condvar_null(&x->_this); }
static inline void z_config_take(z_owned_config_t* this_, z_moved_config_t* x) { *this_ = x->_this; z_config_null(&x->_this); }
static inline void z_encoding_take(z_owned_encoding_t* this_, z_moved_encoding_t* x) { *this_ = x->_this; z_encoding_null(&x->_this); }
static inline void z_fifo_handler_query_take(z_owned_fifo_handler_query_t* this_, z_moved_fifo_handler_query_t* x) { *this_ = x->_this; z_fifo_handler_query_null(&x->_this); }
static inline void z_fifo_handler_reply_take(z_owned_fifo_handler_reply_t* this_, z_moved_fifo_handler_reply_t* x) { *this_ = x->_this; z_fifo_handler_reply_null(&x->_this); }
static inline void z_fifo_handler_sample_take(z_owned_fifo_handler_sample_t* this_, z_moved_fifo_handler_sample_t* x) { *this_ = x->_this; z_fifo_handler_sample_null(&x->_this); }
static inline void z_hello_take(z_owned_hello_t* this_, z_moved_hello_t* x) { *this_ = x->_this; z_hello_null(&x->_this); }
static inline void z_keyexpr_take(z_owned_keyexpr_t* this_, z_moved_keyexpr_t* x) { *this_ = x->_this; z_keyexpr_null(&x->_this); }
static inline void z_mutex_take(z_owned_mutex_t* this_, z_moved_mutex_t* x) { *this_ = x->_this; z_mutex_null(&x->_this); }
static inline void z_publisher_take(z_owned_publisher_t* this_, z_moved_publisher_t* x) { *this_ = x->_this; z_publisher_null(&x->_this); }
static inline void z_query_take(z_owned_query_t* this_, z_moved_query_t* x) { *this_ = x->_this; z_query_null(&x->_this); }
static inline void z_queryable_take(z_owned_queryable_t* this_, z_moved_queryable_t* x) { *this_ = x->_this; z_queryable_null(&x->_this); }
static inline void z_reply_take(z_owned_reply_t* this_, z_moved_reply_t* x) { *this_ = x->_this; z_reply_null(&x->_this); }
static inline void z_reply_err_take(z_owned_reply_err_t* this_, z_moved_reply_err_t* x) { *this_ = x->_this; z_reply_err_null(&x->_this); }
static inline void z_ring_handler_query_take(z_owned_ring_handler_query_t* this_, z_moved_ring_handler_query_t* x) { *this_ = x->_this; z_ring_handler_query_null(&x->_this); }
static inline void z_ring_handler_reply_take(z_owned_ring_handler_reply_t* this_, z_moved_ring_handler_reply_t* x) { *this_ = x->_this; z_ring_handler_reply_null(&x->_this); }
static inline void z_ring_handler_sample_take(z_owned_ring_handler_sample_t* this_, z_moved_ring_handler_sample_t* x) { *this_ = x->_this; z_ring_handler_sample_null(&x->_this); }
static inline void z_sample_take(z_owned_sample_t* this_, z_moved_sample_t* x) { *this_ = x->_this; z_sample_null(&x->_this); }
static inline void z_session_take(z_owned_session_t* this_, z_moved_session_t* x) { *this_ = x->_this; z_session_null(&x->_this); }
static inline void z_slice_take(z_owned_slice_t* this_, z_moved_slice_t* x) { *this_ = x->_this; z_slice_null(&x->_this); }
static inline void z_string_array_take(z_owned_string_array_t* this_, z_moved_string_array_t* x) { *this_ = x->_this; z_string_array_null(&x->_this); }
static inline void z_string_take(z_owned_string_t* this_, z_moved_string_t* x) { *this_ = x->_this; z_string_null(&x->_this); }
static inline void z_subscriber_take(z_owned_subscriber_t* this_, z_moved_subscriber_t* x) { *this_ = x->_this; z_subscriber_null(&x->_this); }
static inline void z_task_take(z_owned_task_t* this_, z_moved_task_t* x) { *this_ = x->_this; z_task_null(&x->_this); }
static inline void zc_closure_log_take(zc_owned_closure_log_t* closure_, zc_moved_closure_log_t* x) { *closure_ = x->_this; zc_closure_log_null(&x->_this); }
...
#define _z_check(this_) \
    _Generic((this_), \
        z_owned_bytes_t : _z_bytes_check, \
        z_owned_closure_hello_t : _z_closure_hello_check, \
        z_owned_closure_query_t : _z_closure_query_check, \
        z_owned_closure_reply_t : _z_closure_reply_check, \
        z_owned_closure_sample_t : _z_closure_sample_check, \
        z_owned_condvar_t : _z_condvar_check, \
        z_owned_config_t : _z_config_check, \
        z_owned_encoding_t : _z_encoding_check, \
        z_owned_fifo_handler_query_t : _z_fifo_handler_query_check, \
        z_owned_fifo_handler_reply_t : _z_fifo_handler_reply_check, \
        z_owned_fifo_handler_sample_t : _z_fifo_handler_sample_check, \
        z_owned_hello_t : _z_hello_check, \
        z_owned_keyexpr_t : _z_keyexpr_check, \
        z_owned_mutex_t : _z_mutex_check, \
        z_owned_publisher_t : _z_publisher_check, \
        z_owned_query_t : _z_query_check, \
        z_owned_queryable_t : _z_queryable_check, \
        z_owned_reply_t : _z_reply_check, \
        z_owned_reply_err_t : _z_reply_err_check, \
        z_owned_ring_handler_query_t : _z_ring_handler_query_check, \
        z_owned_ring_handler_reply_t : _z_ring_handler_reply_check, \
        z_owned_ring_handler_sample_t : _z_ring_handler_sample_check, \
        z_owned_sample_t : _z_sample_check, \
        z_owned_session_t : _z_session_check, \
        z_owned_slice_t : _z_slice_check, \
        z_owned_string_array_t : _z_string_array_check, \
        z_owned_string_t : _z_string_check, \
        z_owned_subscriber_t : _z_subscriber_check, \
        z_owned_task_t : _z_task_check, \
        zc_owned_closure_log_t : _zc_closure_log_check \
    )(&this_)
...
inline void _z_null(z_owned_bytes_t* this_) { _z_bytes_null(this_); };
inline void _z_null(z_owned_closure_hello_t* this_) { _z_closure_hello_null(this_); };
inline void _z_null(z_owned_closure_query_t* this_) { _z_closure_query_null(this_); };
inline void _z_null(z_owned_closure_reply_t* this_) { _z_closure_reply_null(this_); };
inline void _z_null(z_owned_closure_sample_t* this_) { _z_closure_sample_null(this_); };
inline void _z_null(z_owned_condvar_t* this_) { _z_condvar_null(this_); };
inline void _z_null(z_owned_config_t* this_) { _z_config_null(this_); };
inline void _z_null(z_owned_encoding_t* this_) { _z_encoding_null(this_); };
inline void _z_null(z_owned_fifo_handler_query_t* this_) { _z_fifo_handler_query_null(this_); };
inline void _z_null(z_owned_fifo_handler_reply_t* this_) { _z_fifo_handler_reply_null(this_); };
inline void _z_null(z_owned_fifo_handler_sample_t* this_) { _z_fifo_handler_sample_null(this_); };
inline void _z_null(z_owned_hello_t* this_) { _z_hello_null(this_); };
inline void _z_null(z_owned_keyexpr_t* this_) { _z_keyexpr_null(this_); };
inline void _z_null(z_owned_mutex_t* this_) { _z_mutex_null(this_); };
inline void _z_null(z_owned_publisher_t* this_) { _z_publisher_null(this_); };
inline void _z_null(z_owned_query_t* this_) { _z_query_null(this_); };
inline void _z_null(z_owned_queryable_t* this_) { _z_queryable_null(this_); };
inline void _z_null(z_owned_reply_err_t* this_) { _z_reply_err_null(this_); };
inline void _z_null(z_owned_reply_t* this_) { _z_reply_null(this_); };
inline void _z_null(z_owned_ring_handler_query_t* this_) { _z_ring_handler_query_null(this_); };
inline void _z_null(z_owned_ring_handler_reply_t* this_) { _z_ring_handler_reply_null(this_); };
inline void _z_null(z_owned_ring_handler_sample_t* this_) { _z_ring_handler_sample_null(this_); };
inline void _z_null(z_owned_sample_t* this_) { _z_sample_null(this_); };
inline void _z_null(z_owned_session_t* this_) { _z_session_null(this_); };
inline void _z_null(z_owned_slice_t* this_) { _z_slice_null(this_); };
inline void _z_null(z_owned_string_array_t* this_) { _z_string_array_null(this_); };
inline void _z_null(z_owned_string_t* this_) { _z_string_null(this_); };
inline void _z_null(z_owned_subscriber_t* this_) { _z_subscriber_null(this_); };
inline void _z_null(z_owned_task_t* this_) { _z_task_null(this_); };
inline void _z_null(zc_owned_closure_log_t* this_) { _zc_closure_log_null(this_); };
...
inline bool _z_check(const z_owned_bytes_t& this_) { return _z_bytes_check(&this_); };
inline bool _z_check(const z_owned_closure_hello_t& this_) { return _z_closure_hello_check(&this_); };
inline bool _z_check(const z_owned_closure_query_t& this_) { return _z_closure_query_check(&this_); };
inline bool _z_check(const z_owned_closure_reply_t& this_) { return _z_closure_reply_check(&this_); };
inline bool _z_check(const z_owned_closure_sample_t& this_) { return _z_closure_sample_check(&this_); };
inline bool _z_check(const z_owned_condvar_t& this_) { return _z_condvar_check(&this_); };
inline bool _z_check(const z_owned_config_t& this_) { return _z_config_check(&this_); };
inline bool _z_check(const z_owned_encoding_t& this_) { return _z_encoding_check(&this_); };
inline bool _z_check(const z_owned_fifo_handler_query_t& this_) { return _z_fifo_handler_query_check(&this_); };
inline bool _z_check(const z_owned_fifo_handler_reply_t& this_) { return _z_fifo_handler_reply_check(&this_); };
inline bool _z_check(const z_owned_fifo_handler_sample_t& this_) { return _z_fifo_handler_sample_check(&this_); };
inline bool _z_check(const z_owned_hello_t& this_) { return _z_hello_check(&this_); };
inline bool _z_check(const z_owned_keyexpr_t& this_) { return _z_keyexpr_check(&this_); };
inline bool _z_check(const z_owned_mutex_t& this_) { return _z_mutex_check(&this_); };
inline bool _z_check(const z_owned_publisher_t& this_) { return _z_publisher_check(&this_); };
inline bool _z_check(const z_owned_query_t& query) { return _z_query_check(&query); };
inline bool _z_check(const z_owned_queryable_t& this_) { return _z_queryable_check(&this_); };
inline bool _z_check(const z_owned_reply_t& this_) { return _z_reply_check(&this_); };
inline bool _z_check(const z_owned_reply_err_t& this_) { return _z_reply_err_check(&this_); };
inline bool _z_check(const z_owned_ring_handler_query_t& this_) { return _z_ring_handler_query_check(&this_); };
inline bool _z_check(const z_owned_ring_handler_reply_t& this_) { return _z_ring_handler_reply_check(&this_); };
inline bool _z_check(const z_owned_ring_handler_sample_t& this_) { return _z_ring_handler_sample_check(&this_); };
inline bool _z_check(const z_owned_sample_t& this_) { return _z_sample_check(&this_); };
inline bool _z_check(const z_owned_session_t& this_) { return _z_session_check(&this_); };
inline bool _z_check(const z_owned_slice_t& this_) { return _z_slice_check(&this_); };
inline bool _z_check(const z_owned_string_array_t& this_) { return _z_string_array_check(&this_); };
inline bool _z_check(const z_owned_string_t& this_) { return _z_string_check(&this_); };
inline bool _z_check(const z_owned_subscriber_t& this_) { return _z_subscriber_check(&this_); };
inline bool _z_check(const z_owned_task_t& this_) { return _z_task_check(&this_); };
inline bool _z_check(const zc_owned_closure_log_t& this_) { return _zc_closure_log_check(&this_); };
